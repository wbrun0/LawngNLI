...
ref={}
for dataset in ['LawngNLI_long_premise_filtered_BM25','LawngNLI_short_premise_short_LawngNLI_long_premise_filtered_BM25','LawngNLI_short_premise_short_LawngNLI_long_premise','base_LawngNLI_short_premise','base_LawngNLI_long_premise','LawngNLI_short_premise','LawngNLI_short_premise_negation','LawngNLI_short_premise_length','short_512_LawngNLI_long_premise','LawngNLI_short_premise_filtered_BM25_short_LawngNLI_long_premise_filtered_BM25','LawngNLI_long_premise','LawngNLI_long_premise_negation','LawngNLI_long_premise_length','LawngNLI_hypothesis_only','LawngNLI_short_premise_only_short_LawngNLI_long_premise_filtered_BM25_only','LawngNLI_short_premise_filtered_BM25_only_short_LawngNLI_long_premise_filtered_BM25_only','LawngNLI_long_premise_filtered_BM25_only']:
	dataset2=dataset
	...
	for finetune in ['-finetune2-3-']:
		data2=data.copy()
		for model_name in [
		'allenai_longformer-base-4096/model/model/cp-vanilla.model',
		'google_bigbird-roberta-base/model/model/cp-vanilla.model',
		'zlucia_custom-legalbert/model/model/cp-vanilla.model',
		'nlpaueb_legal-bert-base-uncased/model/model/cp-vanilla.model',
		'facebook_bart-large/model/model/cp-vanilla.model',
		'albert-xxlarge-v2/model/model/cp-vanilla.model',
		'roberta-large/model/model/cp-vanilla.model',
		'allenai_longformer-base-4096/model/model/cp-anli.model',
		'google_bigbird-roberta-base/model/model/cp-anli.model',
		'zlucia_custom-legalbert/model/model/cp-anli.model',
		'nlpaueb_legal-bert-base-uncased/model/model/cp-anli.model',
		'facebook_bart-large/model/model/cp-anli.model',
		'albert-xxlarge-v2/model/model/cp-anli.model',
		'roberta-large/model/model/cp-anli.model',
		'allenai_longformer-base-4096/model/model/cp-DocNLI.model',
		'google_bigbird-roberta-base/model/model/cp-DocNLI.model',
		'zlucia_custom-legalbert/model/model/cp-DocNLI.model',
		'nlpaueb_legal-bert-base-uncased/model/model/cp-DocNLI.model',
		'facebook_bart-large/model/model/cp-DocNLI.model',
		'albert-xxlarge-v2/model/model/cp-DocNLI.model',
		'roberta-large/model/model/cp-DocNLI.model',
		'allenai_longformer-base-4096/model/model/cp-ConTRoL-dataset.model',
		'google_bigbird-roberta-base/model/model/cp-ConTRoL-dataset.model',
		'zlucia_custom-legalbert/model/model/cp-ConTRoL-dataset.model',
		'nlpaueb_legal-bert-base-uncased/model/model/cp-ConTRoL-dataset.model',
		'facebook_bart-large/model/model/cp-ConTRoL-dataset.model',
		'albert-xxlarge-v2/model/model/cp-ConTRoL-dataset.model',
		'roberta-large/model/model/cp-ConTRoL-dataset.model',
		]:
			data=data2.copy()
				...
				for hypothesis in ['hypothesis']:
					for premise in ['premise']: 
								...
								for hypothesis_only in ['premise_included']:
									...
									if dataset2=='LawngNLI_long_premise_filtered_BM25':
										ref[model_name]=((label)==(torch.Tensor(probability)))
									if re.search('long',dataset2) and not re.search('negation',dataset2) and not re.search('length',dataset2) and model_name in ref.keys():
										results.at[model_name,hypothesis_only+'_'+dataset2+'_'+finetune+'_diff']=(pd.Series(results.at[model_name,hypothesis_only+'_LawngNLI_long_premise_filtered_BM25_'+finetune]).str.replace('\+.*','').astype(float)-pd.Series(results.at[model_name,hypothesis_only+'_'+dataset2+'_'+finetune]).str.replace('\+.*','').astype(float)).round(3)[0]
										results.at[model_name,hypothesis_only+'_'+dataset2+'_'+finetune+'_p_value']=round(mcnemar(pd.crosstab(ref[model_name].numpy(),((label)==(torch.Tensor(probability))).numpy()).to_numpy(), exact=True).pvalue,3)
			except:
				os.chdir('..')
				print(model_name)
	print(results)
results = results.reindex(sorted(results.columns), axis=1)
results.to_csv('_all_test.csv')
